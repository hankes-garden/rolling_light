...
const int BASE_FREQ = 67;   // base frequency for synchronization & luminance padding
                            // Note: this value must be less than all the color frequencies!
...
void initLights(CState* arrLightPatterns[])
{
    ...
    int arrPins_l1 [STATE_COUNT_L1] = {2,3,4,0};
    ...
    int arrPins_l2 [STATE_COUNT_L2] = {5,6,7,0};
